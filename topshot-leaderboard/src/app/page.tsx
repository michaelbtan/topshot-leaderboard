...
const data = [
  { id: 1, name: "dawgfan122", strats: 251 },
  { id: 2, name: "zazu", strats: 200 },
  { id: 3, name: "tennisplayer12", strats: 65 },
  { id: 4, name: "wrightkdarius3", strats: 64 },
  { id: 5, name: "AlexPDV", strats: 50 },
  { id: 6, name: "ashtonholley", strats: 50 },
  { id: 7, name: "byrd_up", strats: 50 },
  { id: 8, name: "cartpig", strats: 50 },
  { id: 9, name: "cbass47", strats: 50 },
  { id: 10, name: "daniel.maltzman", strats: 50 },
  { id: 11, name: "embeuu", strats: 50 },
  { id: 12, name: "gabass02", strats: 50 },
  { id: 13, name: "ghost", strats: 50 },
  { id: 14, name: "jamftils", strats: 50 },
  { id: 15, name: "jaykidd", strats: 50 },
  { id: 16, name: "jmetz.ny", strats: 50 },
  { id: 17, name: "josey03", strats: 50 },
  { id: 18, name: "kidbamboo73", strats: 50 },
  { id: 19, name: "ljdudmarie", strats: 50 },
  { id: 20, name: "oldhazeleyes", strats: 50 },
  { id: 21, name: "runitupclay", strats: 50 },
